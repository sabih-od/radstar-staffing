...
<form class="form-inline">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="seeker_id" value="{{$seeker->id}}">
      ...
      <div class="input-group-prepend"> <button type="submit" class="input-group-text" id="inputGroupPrepend3"><i class="fas fa-paper-plane" aria-hidden="true"></i></button> </div>
    </div>
  </div>
